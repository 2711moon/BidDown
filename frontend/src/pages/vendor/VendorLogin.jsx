...
const VendorLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      try {
        const adminRes = await axios.post((import.meta.env.VITE_API_URL || 'http://localhost:5000') + '/api/admin/login', {
      ...
      const res = await axios.post((import.meta.env.VITE_API_URL || 'http://localhost:5000') + '/api/vendor/login', formData);
